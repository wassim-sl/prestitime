 ...
 */
final class Version20250727174310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ligne_de_commande (id INT AUTO_INCREMENT NOT NULL, commande_id INT DEFAULT NULL, quantité_article INT NOT NULL, prix_unitaire_article DOUBLE PRECISION NOT NULL, INDEX IDX_7982ACE682EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
